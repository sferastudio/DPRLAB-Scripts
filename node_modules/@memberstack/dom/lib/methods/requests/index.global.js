var MemberstackDOM = (() => {
  ...
  var require_supports_color = __commonJS({
    "../../node_modules/supports-color/index.js"(exports, module) {
      ...
      function getSupportLevel(stream4, options = {}) {
        const level = supportsColor(stream4, __spreadValues({
    ...
    return {
      sendRequest: (data, options) => __async(void 0, null, function* () {
        ...
        try {
          ...
          const formattedUrl = `${customEndpoint || endpoints.API}${url2}`;
      ...
      sendRequestWithFetch: (data, options) => __async(void 0, null, function* () {
        var _a, _b;
        try {
          const { url: url2, method, data: bodyData, headers, contentType } = data;
          const memberToken = getMemberToken();
          const authHeader = [
  ...
  var openSignInWindow = (url2, name) => __async(void 0, null, function* () {
    ...
    if (windowObjectReference === null || windowObjectReference.closed) {
      windowObjectReference = window.open(url2, name, strWindowFeatures);
    } else if (previousUrl !== url2) {
      windowObjectReference = window.open(url2, name, strWindowFeatures);
  ...
  return __toCommonJS(requests_exports);
})();
